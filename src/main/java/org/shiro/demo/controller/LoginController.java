...
public class LoginController {
	...
	public String login(User currUser,HttpSession session, HttpServletRequest request){
		...
		String pwd  = RSAUtils.decryptStringByJs(currUser.getPassword());//RSAUtils.decryptStringByJs(currUser.getPassword());
		logger.info(pwd);
	...
	public String getRasRepair(){
		PublicKeyMap publicKeyMap = RSAUtils.getPublicKeyMap();//RSAUtils.getPublicKeyMap();
